    ...
    <main class="container-fluid d-flex flex-column flex-grow-1">
        ...
        <form action="ListarPrestamoServlet" method="get" class="row g-3 mb-3">
            <div class="col-md-3">
                ...
                if (estadoSel == null) estadoSel = "";
                %>
                <select name="estado" id="estado" class="form-select">
                    <option value="" <%= estadoSel.equals("") ? "selected" : "" %>>Todos</option>
                    <option value="pendiente" <%= estadoSel.equals("pendiente") ? "selected" : "" %>>Pendiente</option>
                    <option value="activo" <%= estadoSel.equals("activo") ? "selected" : "" %>>Activo</option>
                    <option value="rechazado" <%= estadoSel.equals("rechazado") ? "selected" : "" %>>Rechazado</option>
                    <option value="finalizado" <%= estadoSel.equals("finalizado") ? "selected" : "" %>>Finalizado</option>
                </select>
            </div>
            <div class="col-md-2">
            ...
            <div class="col-md-1">
                ...
                <select name="cuotas" id="cuotas" class="form-select">
